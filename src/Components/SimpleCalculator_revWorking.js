...
class SimpleCalculator extends React.Component {
    ...
    power() {        
        if (this.state.operatorCounter == 0) { // If new operation
            ...
            // Do no operation, but iterate caretCounter.
            this.setState((state) => ({
                caretCounter: 1,
            }))
        } else if (this.state.operator == "power"
                && this.state.caretCounter == 1 // Clicking power x2
                && this.state.counter == 0) {
                // Same conditions as "do nothing" except for caretCounter == 1.
            this.square();
            this.setState((state) => ({
                caretCounter: 0,
            }))
            ...
            /*
                ...
                && this.state.caretCounter == 1
                && this.state.counter == 0) { // Square
            this.square();
            this.setState((state) => ({
                displayedWork: state.displayedValue + "^2",
                caretCounter: 0,
            }))
            */
            ...
            <div id="calculator">
                ...
                <div id="interface">
                    ...
                    <div className="container" id="operators_topRowTwo">
                            <button className="button operatorButton textButton" id="square"
